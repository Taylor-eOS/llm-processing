...
with open("input.txt", "r", encoding="utf-8") as infile, \
    ...
    for line in infile:
        ...
        streamer = CaptureStreamer(tokenizer, skip_prompt=True, stop_str=stop_strings)
        _ = model.generate(**enc, streamer=streamer, **gen_kwargs)

        text = "".join(streamer.output).strip()
        outfile.write(text + "\n")
